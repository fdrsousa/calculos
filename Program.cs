...
namespace Calculos
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            double t3 = Conversoes.ConverterDistancia(Conversoes.ConversaoDistancia.MetrosMilhas, 200);
            double t4 = Conversoes.ConverterDistancia(Conversoes.ConversaoDistancia.MilhasMetros, 150);
            Console.WriteLine($"200 Metros = {t3} Milhas");
            Console.WriteLine($"150 Milhas = {t4} Metros");
            Console.ReadKey();
        }
    }
}
